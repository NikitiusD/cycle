    ...
    internal class XmlDocument
    {
        ...
        public void CreateNewXml()
        {
            ...
            foreach (var cycle in cycles)
            {
                ...
                car.Add(new XElement("description", $"Аукционная оценка: {cycle.State}. Дата торгов: {cycle.Date}. \n" +
                                                    "Предоставленная цена расчетная - на основе статистики продаж и может отличаться от фактической цены продажи. \n" +
                                                    "Цена указана с учетом всех расходов по таможне и доставке в Екатеринбург, Москву. \n" +
                                                    "Если вы хотите участвовать в торгах за этот мотоцикл и получить подробное описание, звоните прямо сейчас. \n" +
