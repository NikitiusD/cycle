    ...
    internal class XmlDocument
    {
        ...
        public void CreateNewXml()
        {
            ...
            foreach (var cycle in cycles)
            {
                ...
                car.Add(new XElement("description", $"Аукционная оценка: {cycle.State}." +
                                                    $"Дата торгов: {cycle.Date}." +
                                                    "Цена представлена расчетная на основе статистики продаж и может отличатся от фактической цены продажи." +
